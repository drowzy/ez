...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0e2b3ae61775a3e5f42316ef2a12c1ab) *)
(*
...
let setup_t =
  {
     ...
     build = OCamlbuildPlugin.build ["-use-menhir"];
     test = [];
     doc = [];
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Simon Th\195\182rnqvist"];
          homepage = None;
          bugreports = None;
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ez.ml"})
            ];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\144\187Yl\2429\015\156\253\018\252%J\170\226X";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
